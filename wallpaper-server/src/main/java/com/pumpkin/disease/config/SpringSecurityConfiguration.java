...
import com.pumpkin.disease.filter.SmsAuthenticationFilter;
import com.pumpkin.disease.handler.*;
import com.pumpkin.disease.security.SmsAuthenticationProvider;
...
public class SpringSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private final SmsAuthenticationFailureHandlerImpl smsAuthenticationFailureHandler;
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        SmsAuthenticationProvider mobilePhoneAuthenticationProvider = this.smsAuthenticationProvider();
    ...
    private Set<String> listAnonymous() {
        ...
        anonymousUrls.add("/oauth/**");
        anonymousUrls.add("/login/sms");
        anonymousUrls.add("/type/frontend/**");
        anonymousUrls.add("/image/frontend/pageList");
