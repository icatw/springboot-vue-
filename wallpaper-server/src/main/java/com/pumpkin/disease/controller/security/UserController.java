...
public class UserController {
    ...
    @NormalOperateLog(operateType = REGISTER_OPERATE)
    @AnonymousAccess
    //@PreAuthorize("@mznPerms.checkCurrentUserIsHasPerm('security:user:save')")
    @PostMapping("/register")
    public ResponseResult<?> register(@RequestBody @Valid UserRegisterRequest userRequest) {
        userService.saveUser(BeanCopyUtil.copyObject(userRequest,UserRequest.class));
