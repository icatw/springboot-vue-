...
import com.pumpkin.disease.mapper.*;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public Set<String> listRolePermission(Role role) {
        ...
        //region 获取当前用户关联的菜单id
        Set<Long> idList = roleHalfMenuMapper.listRoleHalfMenu(role.getId());
        idList.addAll(roleMenuMapper.listRoleMenu(role.getId()));
        //endregion
        ...
        return menuMapper.listPermissionByMenuId(idList);
    }
