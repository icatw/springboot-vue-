...
public class SystemConstant {
    ...
    public static class LogType {
         ...
         * 恢复数据
         */
        public static final String RECOVERY_OPERATE = "恢复数据";

        /**
         * 批量恢复
         */
        public static final String BATCH_RECOVERY_OPERATE = "批量恢复";
         ...
         * 注册操作
         */
        public static final String REGISTER_OPERATE = "用户注册";
